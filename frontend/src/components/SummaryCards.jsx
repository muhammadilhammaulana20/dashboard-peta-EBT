export default function SummaryCards({ summary }) {
  ...
  const cards = [
    { icon: 'M3 4h3v16H3V4zm6 4h3v12H9V8zm6-2h3v14h-3V6z', label: 'Total Desa', value: summary.total_desa, color: 'from-teal-500/20 to-teal-600/10', iconBg: 'bg-teal-500/15', iconColor: 'text-teal-400' },
